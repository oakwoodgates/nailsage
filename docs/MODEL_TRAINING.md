...
python scripts/train_model.py --config strategies/your_strategy.yaml

# Train only, skip validation
python scripts/train_model.py --config strategies/your_strategy.yaml --train-only

# Train without saving JSON results
python scripts/train_model.py --config strategies/your_strategy.yaml --no-json
```
...
All scripts use the same YAML configuration format. See `strategies/dev_scalper_1m_v1.yaml` for a complete example.
...
```bash
# Create config file: strategies/my_strategy_v1.yaml

# Train with validation
python scripts/train_model.py --config strategies/my_strategy_v1.yaml
...
python scripts/validate_model.py \
    --config strategies/my_strategy_v1.yaml \
    --model-id abc123_20251126_120000_xyz789
...
strategies/my_strategy_v1_hp1.yaml  # max_depth=5
strategies/my_strategy_v1_hp2.yaml  # max_depth=7
strategies/my_strategy_v1_hp3.yaml  # max_depth=10

# 2. Train all variants
python scripts/train_model.py --config strategies/my_strategy_v1_hp1.yaml
python scripts/train_model.py --config strategies/my_strategy_v1_hp2.yaml
python scripts/train_model.py --config strategies/my_strategy_v1_hp3.yaml
...
- **Examples**: See `strategies/` for example configurations
